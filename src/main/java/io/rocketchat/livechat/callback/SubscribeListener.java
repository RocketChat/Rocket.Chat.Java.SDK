 ...
 */
// TODO: 29/7/17 Future change to make it more generalized, removing type from the method and adding Boolean success and String subId to the code, moving to common like TypingListener
